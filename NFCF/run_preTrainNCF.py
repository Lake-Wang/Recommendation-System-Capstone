...
for topk in [5,7,10,25]:
    ...
    for time in range(10):
        avg_HR_fineTune, avg_NDCG_fineTune = evaluate_model(preTrained_NCF,test_data.values,topk,random_samples, num_uniqueLikes)
...
np.savetxt('results/avg_HR_preTrain.txt',[HR_array])
np.savetxt('results/avg_NDCG_preTrain.txt',[NDCG_array])
